...
int main()
{
    sem_init(&s, 0, 1); // initialize semaphore variable - 1st argument is address of variable, 2nd is number of processes sharing 
                        // semaphore, 3rd argument is the initial value of semaphore variable
